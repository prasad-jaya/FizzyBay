...
elseif ( ! $php_compat || ! $mysql_compat ) :
	...
	if ( ! $mysql_compat && ! $php_compat ) {
		...
		$message = sprintf(
			/* translators: 1: URL to WordPress release notes, 2: WordPress version number, 3: Minimum required MySQL version number, 4: Current MySQL ve number, 3: Minimum required MySQL version number, 4: Current MySQL version number. */
